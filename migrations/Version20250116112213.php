 ...
 */
final class Version20250116112213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE choice (id INT AUTO_INCREMENT NOT NULL, choice_description VARCHAR(255) NOT NULL, episode_id INT NOT NULL, INDEX IDX_C1AB5A92362B62A0 (episode_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE episode (id INT AUTO_INCREMENT NOT NULL, episode_description VARCHAR(255) NOT NULL, story_id INT NOT NULL, INDEX IDX_DDAA1CDAAA5D4036 (story_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE leader_board (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(255) NOT NULL, selected_race_id INT NOT NULL, leader_board_id INT DEFAULT NULL, INDEX IDX_98197A65861DAA93 (selected_race_id), INDEX IDX_98197A65DC4D339C (leader_board_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE race (id INT AUTO_INCREMENT NOT NULL, strength INT NOT NULL, intelligence INT NOT NULL, wisdom INT NOT NULL, agility INT NOT NULL, hp INT NOT NULL, name VARCHAR(100) NOT NULL, what_story_id INT NOT NULL, leader_board_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_DA6FBBAFEAC15B4A (what_story_id), INDEX IDX_DA6FBBAFDC4D339C (leader_board_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE story (id INT AUTO_INCREMENT NOT NULL, story_description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, mail VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
